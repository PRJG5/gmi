...
@section('card-body')
	<form action="{{ route('cards.update', $card)}}" method="POST">
		...
		<div class="form-group row">
			...
			<input name="heading" class="form-control col-sm-9" type="text" value="{{ $card->heading }}" placeholder="@lang('card.heading')" title="@lang('card.heading')" readonly disabled/>
		</div>

		<div class="form-group row">
			<label for="phonetic" class="col-sm-3 col-form-label">@lang('card.phonetic') :</label>
			<input name="phonetic" class="form-control col-sm-9" type="text" value="{{ isset($phonetic) ? $phonetic->text_description : '' }}" placeholder="@lang('card.phonetic')" title="@lang('card.phonetic')"/>
		</div>

		<div class="form-group row">
			<label for="language_id" class="col-sm-3 col-form-label">@lang('card.language') :</label>
			<select name="language_id" class="form-control col-sm-9" type="text" value="" title="@lang('card.language')" readonly disabled>
		...
		<div class="form-group row">
			...
			<select name="domain_id" class="form-control col-sm-9" type="text" value="{{ $card->domain_id }}" title="@lang('card.domain')">
		...
		<div class="form-group row">
			...
			<select name="subdomain_id" class="form-control col-sm-9" type="text" value="{{ $card->subdomain_id }}" title="@lang('card.subdomain')">
		...
		<div class="form-group row">
			...
			<input name="definition" class="form-control col-sm-9" type="text" value="{{ isset($definition) ? $definition->definition_content : '' }}" placeholder="@lang('card.definition')" title="@lang('card.definition')"/>
		</div>

		<div class="form-group row">
			<label for="note" class="col-sm-3 col-form-label">@lang('card.note') :</label>
			<input name="note" class="form-control col-sm-9" type="text" value="{{ isset($note) ? $note->description : '' }}" placeholder="@lang('card.note')" title="@lang('card.note')"/>
		</div>

		<div class="form-group row">
			<label for="context" class="col-sm-3 col-form-label">@lang('card.context') :</label>
			<textarea name="context" class="form-control col-sm-9" placeholder="@lang('card.context')" title="@lang('card.context')">{{ isset($context) ? $context->context_to_string : '' }}</textarea>
		</div>
