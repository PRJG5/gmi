                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
					...
					<ul class="navbar-nav mr-auto">
						...
						<li class="nav-item dropdown">
							<a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">@lang('search.searchBy')</a>
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
								<a class="dropdown-item" href="{{ route('searchCardByAuthor') }}">@lang('card.author')</a>
								<a class="dropdown-item" href="{{ route('searchCard') }}">@lang('card.heading') / @lang('card.language')</a>
							</div>
						</li>
					</ul>
					@endif
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @guest
                            <li class="nav-item"><a class="nav-link" href="{{ route('login') }}">@lang('auth.login')</a> </li>
                            @if (Route::has('register'))
								<li class="nav-item"><a class="nav-link" href="{{ route('register') }}">@lang('auth.register')</a></li>
                            @endif
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ route('searchCardByAuthor') }}">@lang('search.searchCardByAuthor')</a>
                                    @if (Auth::user()->role == \App\Enums\Roles::ADMIN)
                                        <a class="dropdown-item" href="{{ route('allUsers') }}">@lang('users.allUsers')</a>
									...
									<form class="dropdown-item" action="{{ route('logout') }}" method="POST">
										<input class="text" type="submit" value="@lang('auth.logout')" style="all: unset; cursor: pointer;"/>
                                        @csrf
                                    </form>
                                </div>
                            </li>
