...
@section('container-body')
	...
	<div>
		...
		<div class="form-group">
			...
			<input name="domain" id="subdomain" class="form-control" placeholder="@lang('misc.domainName')"
				   type="text"/>
		</div>
	...
	<div>
		...
		<div class="form-group">
			...
			<input name="subdomain" id="subdomain" class="form-control" placeholder="@lang('misc.subdomainName')"
				   type="text"/>
		</div>
	...
	<div>
		<div class="form-group">
			...
			<input id="language" class="form-control" name="language" placeholder="@lang('misc.languageName')"
				   type="text"/>
			<label for="codeIso">@lang('misc.languageISOCode')</label>
			<input id="codeIso" class="form-control" name="codeIso" placeholder="@lang('misc.languageISOCode')"
				   type="text"/>
		</div>
		<br>
		<button onclick="addLanguage()" class="btn btn-primary">@lang('misc.addLanguage')</button>
	</div>
