		...
		<form class="card" action="{{ isset($action) ? $action : '' }}" method="post">
			...
			<div class="cardHeader">
				...
				{{--
					phonetic
				--}}
				<input name="phonetic" class="phonetic" type="text" placeholder="Phonetic" value="{{ isset($phonetic) ? $phonetic->textDescription : '' }}" title="phonetic" {{ (isset($editable) && $editable) ? '' : 'disabled' }}	required />
			</div>
			<div class="cardBody">
				{{--
					domain
